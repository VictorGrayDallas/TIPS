...
namespace TIPS.ViewModels
{
	internal class ReportViewModel
	{
		...
		public async Task RefreshData()
		{
			...
			if (rebuildGrid)
				MainThread.BeginInvokeOnMainThread(ui.RebuildGrid);
			else
				MainThread.BeginInvokeOnMainThread(ui.UpdateNonDataLabels);
			...
			MainThread.BeginInvokeOnMainThread(ui.RefreshData);
		}
